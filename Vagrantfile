...
Vagrant.configure(2) do |config|
  ...
  config.vm.provision :shell, :path => "scripts/intl.sh"
  config.vm.provision :shell, :path => "scripts/opcache-php56.sh"
  config.vm.provision :shell, :path => "scripts/pecl-http.sh"
  config.vm.provision :shell, :path => "scripts/phpini-kunstmaan.sh"
